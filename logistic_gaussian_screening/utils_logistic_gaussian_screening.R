...
logistic_gaussian_screening_directories <- function(base_dir = file.path("output", "logistic_gaussian_screening")) {
  list(
    base = base_dir,
...
ensure_logistic_gaussian_screening_directories <- function(base_dir = file.path("output", "logistic_gaussian_screening")) {
...
run_logistic_gaussian_screening <- function(dataset_name,
                                            ...
                                            make_plots = TRUE,
                                            save_outputs = TRUE,
                                            output_dir = file.path("output", "logistic_gaussian_composite"),
