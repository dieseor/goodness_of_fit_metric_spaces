`.sourceCpp_1_DLLInfo` <- dyn.load('/Users/Diego/Desktop/Codigo/goodness_of_fit_metric_spaces/tests/stress_problem_cases_20260801_183405/cache/R/goodness_of_fit_metric_spaces/sourceCpp/sourceCpp-x86_64-apple-darwin20-1.0.14/sourcecpp_b8b534ef0e1/sourceCpp_2.so')
