`.sourceCpp_1_DLLInfo` <- dyn.load('/Users/Diego/Desktop/Codigo/goodness_of_fit_metric_spaces/tests/stress_exhaustive_10cores_20260801_181758/cache/R/goodness_of_fit_metric_spaces/sourceCpp/sourceCpp-x86_64-apple-darwin20-1.0.14/sourcecpp_163373f9885db/sourceCpp_2.so')
