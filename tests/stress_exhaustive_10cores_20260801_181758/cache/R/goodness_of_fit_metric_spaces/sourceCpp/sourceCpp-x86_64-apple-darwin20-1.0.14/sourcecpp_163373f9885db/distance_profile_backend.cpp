...
// Provisional cache-friendly implementation of the same fast sample-based
// KS/CvM kernel as cpp_fast_sample_ks_cvm_stats().  It preserves the order of
// the sums within every replicate, but traverses replicates together after
// reading each contiguous column of centered_weights and correction.  The
// current production default remains the legacy kernel; this variant is only
// selected explicitly from R for paired validation.
// [[Rcpp::export]]
...
RcppExport SEXP sourceCpp_1_cpp_dp_legendre_matrix(SEXP xSEXP, SEXP l_maxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type x(xSEXP);
    Rcpp::traits::input_parameter< const int >::type l_max(l_maxSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_dp_legendre_matrix(x, l_max));
...
RcppExport SEXP sourceCpp_1_cpp_dp_projection_cdf_legendre_matrix(SEXP x_matrixSEXP, SEXP rSEXP, SEXP coefficientsSEXP, SEXP enforce_boundsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type x_matrix(x_matrixSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type enforce_bounds(enforce_boundsSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_dp_projection_cdf_legendre_matrix(x_matrix, r, coefficients, enforce_bounds));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_dp_normal_profile(SEXP omegaSEXP, SEXP t_valuesSEXP, SEXP muSEXP, SEXP sigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type omega(omegaSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type t_values(t_valuesSEXP);
    Rcpp::traits::input_parameter< const double >::type mu(muSEXP);
    Rcpp::traits::input_parameter< const double >::type sigma(sigmaSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_dp_normal_profile(omega, t_values, mu, sigma));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_dp_normal_profile_matrix(SEXP omegaSEXP, SEXP t_matrixSEXP, SEXP muSEXP, SEXP sigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type omega(omegaSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type t_matrix(t_matrixSEXP);
    Rcpp::traits::input_parameter< const double >::type mu(muSEXP);
    Rcpp::traits::input_parameter< const double >::type sigma(sigmaSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_dp_normal_profile_matrix(omega, t_matrix, mu, sigma));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_dp_weighted_sample_profile_rows(SEXP order_matrixSEXP, SEXP rank_matrixSEXP, SEXP normalized_weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type order_matrix(order_matrixSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type rank_matrix(rank_matrixSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type normalized_weights(normalized_weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_dp_weighted_sample_profile_rows(order_matrix, rank_matrix, normalized_weights));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_dp_weighted_sample_profile_linear(SEXP order_matrixSEXP, SEXP rank_linear_indexSEXP, SEXP normalized_weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type order_matrix(order_matrixSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type rank_linear_index(rank_linear_indexSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type normalized_weights(normalized_weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_dp_weighted_sample_profile_linear(order_matrix, rank_linear_index, normalized_weights));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_profile_lookup_tensor_local_polynomial(SEXP valuesSEXP, SEXP t_gridSEXP, SEXP geometry_gridSEXP, SEXP kappa_gridSEXP, SEXP t_querySEXP, SEXP geometry_querySEXP, SEXP kappa_querySEXP, SEXP stencil_sizeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type values(valuesSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type t_grid(t_gridSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type geometry_grid(geometry_gridSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type kappa_grid(kappa_gridSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type t_query(t_querySEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type geometry_query(geometry_querySEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type kappa_query(kappa_querySEXP);
    Rcpp::traits::input_parameter< const int >::type stencil_size(stencil_sizeSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_profile_lookup_tensor_local_polynomial(values, t_grid, geometry_grid, kappa_grid, t_query, geometry_query, kappa_query, stencil_size));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_fast_sample_ks_cvm_stats(SEXP centered_weightsSEXP, SEXP score_blockSEXP, SEXP obs_order_matrixSEXP, SEXP tie_end_matrixSEXP, SEXP correction_matrixSEXP, SEXP scale_factorSEXP, SEXP compute_ksSEXP, SEXP compute_cvmSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type centered_weights(centered_weightsSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type score_block(score_blockSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type obs_order_matrix(obs_order_matrixSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type tie_end_matrix(tie_end_matrixSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type correction_matrix(correction_matrixSEXP);
    Rcpp::traits::input_parameter< const double >::type scale_factor(scale_factorSEXP);
    Rcpp::traits::input_parameter< const bool >::type compute_ks(compute_ksSEXP);
    Rcpp::traits::input_parameter< const bool >::type compute_cvm(compute_cvmSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_fast_sample_ks_cvm_stats(centered_weights, score_block, obs_order_matrix, tie_end_matrix, correction_matrix, scale_factor, compute_ks, compute_cvm));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_fast_sample_ks_cvm_stats_contiguous_double(SEXP centered_weightsSEXP, SEXP score_blockSEXP, SEXP obs_order_matrixSEXP, SEXP tie_end_matrixSEXP, SEXP correction_matrixSEXP, SEXP scale_factorSEXP, SEXP compute_ksSEXP, SEXP compute_cvmSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type centered_weights(centered_weightsSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type compute_ks(compute_ksSEXP);
    Rcpp::traits::input_parameter< const bool >::type compute_cvm(compute_cvmSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_fast_sample_ks_cvm_stats_contiguous_double(centered_weights, score_block, obs_order_matrix, tie_end_matrix, correction_matrix, scale_factor, compute_ks, compute_cvm));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP sourceCpp_1_cpp_sunspots_joint_profile_block(SEXP radiiSEXP, SEXP rhoSEXP, SEXP center_sSEXP, SEXP time_nodesSEXP, SEXP time_weightsSEXP, SEXP coefficientsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type radii(radiiSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type rho(rhoSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type center_s(center_sSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type time_nodes(time_nodesSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type time_weights(time_weightsSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type coefficients(coefficientsSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_sunspots_joint_profile_block(radii, rho, center_s, time_nodes, time_weights, coefficients));
    return rcpp_result_gen;
END_RCPP
}
