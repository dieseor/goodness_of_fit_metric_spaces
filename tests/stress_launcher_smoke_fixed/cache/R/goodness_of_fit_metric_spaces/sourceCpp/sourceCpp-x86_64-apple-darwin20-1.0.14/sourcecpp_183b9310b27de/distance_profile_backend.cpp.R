`.sourceCpp_1_DLLInfo` <- dyn.load('/Users/Diego/Desktop/Codigo/goodness_of_fit_metric_spaces/tests/stress_launcher_smoke_fixed/cache/R/goodness_of_fit_metric_spaces/sourceCpp/sourceCpp-x86_64-apple-darwin20-1.0.14/sourcecpp_183b9310b27de/sourceCpp_2.so')
