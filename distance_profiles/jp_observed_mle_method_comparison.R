...
run_jp_observed_mle_method_comparison <- function(n_values = c(50L, 100L, 200L),
                                                  ...
                                                  seed = 123L,
                                                  n_cores = 10L,
                                                  output_dir = file.path("output", "calibration", "bootstrap", "jp_observed_mle_method_comparison"),
...
run_jp_jones_pewsey_population_sanity_check <- function(n = 50000L,
                                                        seed = 123L,
                                                        n_cores = 1L,
                                                        output_dir = file.path("output", "calibration", "bootstrap", "jp_jones_pewsey_population_sanity"),
