...
run_rotational_mixture_simple_full_20260601 <- function(
  output_root = file.path("output", "bootstrap_calibration", "rotational_mixtures_simple_full_20260601"),
...
if (sys.nframe() == 0L) {
  run_rotational_mixture_simple_full_20260601()
}
