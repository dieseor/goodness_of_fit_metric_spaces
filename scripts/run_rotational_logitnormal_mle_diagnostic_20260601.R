...
run_logit_diagnostic_config <- function(config_name,
                                        ...
                                        reps = 8L,
                                        seed = 20260601L) {
  theta_true <- rotational_logitnormal_mixture2_normalize_theta(list(
  ...
  for (n in as.integer(n_values)) {
    for (rep_id in seq_len(reps)) {
      ...
      ll_true <- rotational_logitnormal_mixture2_weighted_loglik_s2(
        mu = theta_true$mu,
        weight1 = theta_true$weight1,
        mean1 = theta_true$mean1,
        sd1 = theta_true$sd1,
      ...
      ll_hat <- rotational_logitnormal_mixture2_weighted_loglik_s2(
        mu = fit$mu,
        weight1 = fit$weight1,
        mean1 = fit$mean1,
        sd1 = fit$sd1,
...
run_beta_reference_diagnostic <- function(n_values = c(50L, 200L),
                                          reps = 8L,
                                          seed = 20260611L) {
  theta_true <- rotational_beta_mixture2_normalize_theta(list(
  ...
  for (n in as.integer(n_values)) {
    for (rep_id in seq_len(reps)) {
      ...
      ll_true <- rotational_beta_mixture2_weighted_loglik_s2(
        mu = theta_true$mu,
        weight1 = theta_true$weight1,
        alpha1 = theta_true$alpha1,
        beta1 = theta_true$beta1,
      ...
      ll_hat <- rotational_beta_mixture2_weighted_loglik_s2(
        mu = fit$mu,
        weight1 = fit$weight1,
        alpha1 = fit$alpha1,
        beta1 = fit$beta1,
...
main <- function() {
  output_dir <- file.path("output", "rotational_logitnormal_mle_diagnostic_20260601")
  ...
  configs <- list(
    ...
    clipped_mean15 = list(
      rotational_logitnormal_mixture2_clip_means = TRUE,
      rotational_logitnormal_mixture2_mean_lower = -15,
      rotational_logitnormal_mixture2_mean_upper = 15,
      rotational_logitnormal_mixture2_sd_lower = 0.05,
      rotational_logitnormal_mixture2_sd_upper = 5,
      rotational_logitnormal_mixture2_weight_eps = 0.01,
      rotational_logitnormal_mixture2_optim_control = list(maxit = 250L, reltol = 1e-9)
    ...
    clipped_sd015_weps005 = list(
      ...
      rotational_logitnormal_mixture2_mean_lower = -15,
      rotational_logitnormal_mixture2_mean_upper = 15,
      rotational_logitnormal_mixture2_sd_lower = 0.15,
      rotational_logitnormal_mixture2_sd_upper = 5,
      rotational_logitnormal_mixture2_weight_eps = 0.05,
      rotational_logitnormal_mixture2_optim_control = list(maxit = 250L, reltol = 1e-9)
    ),
    unrestricted_sd015_weps005 = list(
      rotational_logitnormal_mixture2_clip_means = FALSE,
      rotational_logitnormal_mixture2_mean_lower = -15,
      rotational_logitnormal_mixture2_mean_upper = 15,
      rotational_logitnormal_mixture2_sd_lower = 0.15,
      rotational_logitnormal_mixture2_sd_upper = 5,
