...
section6_scenario_catalog <- function() {
  list(
    ...
    hvmf_1_radial_c_sqrt2 = list(
      family = "hvmf",
      alternative = "radial_hvmf_location_mixture_c_sqrt2",
      description = "(1-beta/2) HvMF((sqrt(2),e1),d) + (beta/2) HvMF(mu1,d), d_H(mu0,mu1)=sqrt(2/d)",
      generator = "hvmf_radial_location_mixture",
      experimental = TRUE
    ),
